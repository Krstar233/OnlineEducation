<template>
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px; overflow: hidden">
                  ...
                  <li>
                    <div class="u-face">
                      <a :href="'/teacher/' + courseInfo.teacherId">
                        <img :src="courseInfo.teacherAvatar" width="50" height="50" alt>
                      </a>
                    </div>
    ...
    created() {
      ...
      course.getCourseDetail(courseId)
        .then(res=>{
          ...
          this.courseInfo.price = parseFloat(this.courseInfo.price).toFixed(2)
        })
      course.getChapterVideoList(courseId)
        .then(res=>{
